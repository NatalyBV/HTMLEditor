...
import task3209.actions.RedoAction;
import task3209.actions.StrikeThroughAction;
import task3209.actions.SubscriptAction;
import task3209.actions.SuperscriptAction;
import task3209.actions.UndoAction;
...
public class MenuHelper {
  ...
  public static void initFontMenu(View view, JMenuBar menuBar) {
    ...
    String[] fontTypes = {Font.SANS_SERIF, Font.SERIF, Font.MONOSPACED, Font.DIALOG,
        Font.DIALOG_INPUT};
  ...
  public static void initAlignMenu(View view, JMenuBar menuBar) {
    ...
    addMenuItem(alignMenu,
        new StyledEditorKit.AlignmentAction("По левому краю", StyleConstants.ALIGN_LEFT));
    addMenuItem(alignMenu,
        new StyledEditorKit.AlignmentAction("По центру", StyleConstants.ALIGN_CENTER));
    addMenuItem(alignMenu,
        new StyledEditorKit.AlignmentAction("По правому краю", StyleConstants.ALIGN_RIGHT));
